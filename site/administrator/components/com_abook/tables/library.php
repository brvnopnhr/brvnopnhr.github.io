...
class AbookTableLibrary extends JTable
{
	public function __construct(& $db) {
		parent::__construct('#__ablibrary', 'id', $db);
	}
	...
	function check()
        {
                ...
                if (trim($this->name) == '') {
                        $this->setError(JText::_('LIBRARY ITEM MUST HAVE A NAME'));
                        return false;
                }
        ...
        function delete ($pk=null)
        {
                ...
                $query = 'SELECT * FROM #__abbook WHERE idlibrary = '.$pk;
