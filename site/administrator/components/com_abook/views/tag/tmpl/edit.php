...
<form action="<?php JRoute::_('index.php?option=com_abook&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
                ...
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', empty($this->item->id) ? JText::_('COM_ABOOK_ADD_NEW_TAG') : JText::sprintf('COM_ABOOK_EDIT_TAG', true)); ?>
                <div class="row-fluid">
                        <div class="span9">
			...
			<div class="span3">
				<div class="control-group">
					<?php echo $this->form->getLabel('id_taggroup'); ?>
                        		<?php echo $this->form->getInput('id_taggroup'); ?>
				</div>
				<div class="control-group">
