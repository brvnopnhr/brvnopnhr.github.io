...
{	
	...
	public function displayVideo($url, $view = 0, $ywidth = 0, $yheight = 0) {
		...
		if ($url != '' && PhocaDownloadUtils::isURLAddress($url) ) {
			...
			.'<embed src="'.$yLink.$code.'" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" height="'.(int)$youtubeheight.'" width="'.(int)$youtubewidth.'"></embed></object>';
		}
		return $o;
	}
}
