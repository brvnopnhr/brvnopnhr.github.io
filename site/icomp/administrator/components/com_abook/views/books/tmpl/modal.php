...
?>
<form action="<?php echo JRoute::_('index.php?option=com_abook&view=books&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	<fieldset class="filter clearfix">
		...
		<div class="filters pull-left">
			...
			<select name="filter_category_id" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', JHtml::_('categoryparent.options', 'com_abook'), 'value', 'text', $this->state->get('filter.category_id'));?>
			</select>
		</div>
	</fieldset>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center nowrap">
					<?php echo JHTML::_('date',$item->dateinsert, JText::_('DATE_FORMAT_LC4')); ?>
				</td>
				<td class="center">
