...
class AbookViewEditor extends JViewLegacy
{
	...
	protected function addToolbar()
		...
		$icon = $isNew ? 'editoradd' : 'editoredit';
		JToolBarHelper::title(JText::_('COM_ABOOK_PAGE_'.($checkedOut ? 'VIEW_EDITOR' : ($isNew ? 'ADD_EDITOR' : 'EDIT_EDITOR'))), $icon);
                ...
                if (empty($this->item->id))  {
                        JToolBarHelper::cancel('editor.cancel');
                } else {
